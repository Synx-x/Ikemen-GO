			...
			if !bridge.Truthy() {
				...
				bridge.Set("engineStatus", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
					...
					return js.ValueOf(map[string]interface{}{
						...
						"texUploadWorstMs":   texUploadWorstMs,
						"texUploadLastMs":    texUploadLastMs,
						"texUploadCount":     texUploadCount,
						"texUploadBytesMax":  texUploadBytesMax,
						"mtTaskWorstMs":      mtTaskWorstMs,
						"mtTaskCount":        mtTaskCount,
						"gcNum":              int(ms.NumGC),
						...
						"esc":                sys.esc,
						"meActive":           sys.motif.me.active,
						"paused":             sys.paused,
						"keyStateEsc":        sys.keyState[KeyEscape],
						"p1chars":            p1n,
						"p2chars":            p2n,
						"stageDef":           stageName,
